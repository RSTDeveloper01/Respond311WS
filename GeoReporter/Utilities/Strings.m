...
NSString * const kUI_Error463               = @"error_463";
NSString * const kUI_CommError              = @"general_communication_error";
NSString * const kUI_locSrvTurnedOff_title  = @"locSrvTurnedOff_title";
NSString * const kUI_locSrvTurnedOff_desc   = @"locSrvTurnedOff_desc";
